              ...
              <div class="card gradient-bottom">
                <div class="card-header">
                  ...
                  <div class="card-header-action dropdown">
                    <a href="https://demo.getstisla.com/index.html#" data-toggle="dropdown" class="btn btn-danger dropdown-toggle">Month</a>
                    <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                      <li class="dropdown-title">Select Period</li>
                      <li><a href="https://demo.getstisla.com/index.html#" class="dropdown-item">Today</a></li>
                      <li><a href="https://demo.getstisla.com/index.html#" class="dropdown-item">Week</a></li>
                      <li><a href="https://demo.getstisla.com/index.html#" class="dropdown-item active">Month</a></li>
                      <li><a href="https://demo.getstisla.com/index.html#" class="dropdown-item">This Year</a></li>
                    </ul>
                  </div>
                </div>
                <div class="card-body" id="top-5-scroll" tabindex="2" style="height: 315px; overflow: hidden; outline: none;">
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="./Ecommerce Dashboard — Stisla_files/product-3-50.png" alt="product">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="./Ecommerce Dashboard — Stisla_files/product-4-50.png" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="./Ecommerce Dashboard — Stisla_files/product-1-50.png" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="./Ecommerce Dashboard — Stisla_files/product-5-50.png" alt="product">
                      <div class="media-body">
            ...
            <div class="col-md-6">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-421px, 0px, 0px); transition: all 0s ease 0s; width: 1266px;"><div class="owl-item cloned" style="width: 130.556px; margin-right: 10px;"><div>
                      <div class="product-item pb-3">
                        <div class="product-image">
                          <img alt="image" src="./Ecommerce Dashboard — Stisla_files/product-4-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
                          ...
                          <div class="product-cta">
                            <a href="https://demo.getstisla.com/index.html#" class="btn btn-primary">Detail</a>
                          </div>
                        </div>  
                      </div>
                    </div></div><div class="owl-item cloned" style="width: 130.556px; margin-right: 10px;"><div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="./Ecommerce Dashboard — Stisla_files/product-3-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
                      ...
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="./Ecommerce Dashboard — Stisla_files/product-1-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
                    ...
                    </div></div><div class="owl-item active" style="width: 130.556px; margin-right: 10px;"><div>
                      <div class="product-item pb-3">
                        <div class="product-image">
                          <img alt="image" src="./Ecommerce Dashboard — Stisla_files/product-4-50.png" class="img-fluid">
                        </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="./Ecommerce Dashboard — Stisla_files/id.svg" alt="image" width="40">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="./Ecommerce Dashboard — Stisla_files/my.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="./Ecommerce Dashboard — Stisla_files/us.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                    ...
                    <div class="col-sm-6 mt-sm-0 mt-4">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="./Ecommerce Dashboard — Stisla_files/ps.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="./Ecommerce Dashboard — Stisla_files/de.svg" alt="image" width="40">
                          <div class="media-body ml-3">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <a href="https://demo.getstisla.com/index.html#" class="btn btn-danger">View More <i class="fas fa-chevron-right"></i></a>
                  </div>
                </div>
                <div class="card-body p-0">
                  <div class="table-responsive table-invoice">
                    <table class="table table-striped">
                      ...
                      <tr>
                        <td><a href="https://demo.getstisla.com/index.html#">INV-87239</a></td>
                      ...
                      <tr>
                        <td><a href="https://demo.getstisla.com/index.html#">INV-48574</a></td>
                      ...
                      <tr>
                        <td><a href="https://demo.getstisla.com/index.html#">INV-76824</a></td>
                      ...
                      <tr>
                        <td><a href="https://demo.getstisla.com/index.html#">INV-84990</a></td>
                      ...
                      <tr>
                        <td><a href="https://demo.getstisla.com/index.html#">INV-87320</a></td>
              ...
              <div class="card card-hero">
                ...
                <div class="card-body p-0">
                  <div class="tickets-list">
                    <a href="https://demo.getstisla.com/index.html#" class="ticket-item">
                    ...
                    <a href="https://demo.getstisla.com/features-tickets.html" class="ticket-item ticket-more">
